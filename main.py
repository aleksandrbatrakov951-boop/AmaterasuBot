...
async def graph_command(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    for admin_id, admin_info in ADMINS.items():
        ...
        graph_text += f"👤 {admin_info['name']}: {create_small_bar(admin_percentage)} {admin_percentage:.0f}% ({admin_answered}/{admin_total})\n"
...
def main():
    ...
    try:
        ...
        handlers = [
            ...
            CommandHandler("graph", graph_command),  # Новая команда для графиков
